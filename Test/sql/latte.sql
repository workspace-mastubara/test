...
insert into user_info(user_id,password) values("guest","guest"),
												...
												("guest11","guest11")
												("guest12","guest12");
insert into product_info(product_name,product_name_kana,product_description,category_id,price)
	values("少年漫画","しょうねんまんが","少年漫画です",0,100),
			("少女漫画","しょうじょまんが","少女漫画です",0,100),
			("小説","しょうせつ","小説です",0,100),
			("雑誌","ざっし","雑誌です",0,100),
			("参考書","さんこうしょ","参考書です",0,100),
			("冷蔵庫","れいぞうこ","冷蔵庫です",1,100),
			("洗濯機","せんたくき","洗濯機です",1,100),
			("ドライヤー","どらいやー","ドライヤーです",1,100),
			("電子レンジ","でんしれんじ","電子レンジです",1,100),
			("掃除機","そうじき","掃除機です",1,100),
			("ロボ","ろぼ","ロボットです",2,100),
			("人形","にんぎょう","人形です",2,100),
			("つみき","つみき","つみきです",2,100),
			("ゲーム","ゲーム","ゲームです",2,100),
			("エアガン","えあがん","エアガンです",2,100),
			("JPOP","JPOP","JPOPです",3,00),
			("HipHop","HipHop","HipHopです",3,100),
			("クラシック","くらしっく","クラシックです",3,100),
			("アニソン","あにそん","アニソンです",3,100),
			("演歌","えんか","演歌です",3,100);
